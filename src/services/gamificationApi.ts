...
export const gamificationApi = {
  ...
  checkIn: () => fetchWithAuth<{ success: boolean; result: CheckInResult }>('/gamification/checkin', { method: 'POST' }),

  // Quests
  getQuests: () => fetchWithAuth<{ success: boolean; quests: Quest[] }>('/gamification/quests'),
  getMyQuests: () => fetchWithAuth<{ success: boolean; quests: UserQuest[] }>('/gamification/quests/mine'),
  ...
  getMyAchievements: () => fetchWithAuth<{ success: boolean; achievements: UserAchievement[] }>('/gamification/achievements/mine'),
  getAchievementProgress: () => fetchWithAuth<{ success: boolean; progress: AchievementProgress[] }>('/gamification/achievements/progress'),
  ...
  // Referrals
  getReferralStats: () => fetchWithAuth<{ success: boolean; stats: ReferralStats }>('/gamification/referral/stats'),
  getReferrals: () => fetchWithAuth<{ success: boolean; referrals: ReferralUser[] }>('/gamification/referral/list'),
